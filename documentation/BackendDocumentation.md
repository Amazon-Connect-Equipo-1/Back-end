...
| Field     | Validation                                                                                              |
| --------- | ------------------------------------------------------------------------------------------------------- |
| email     | Must be a valid email that hasn't been registered                                                       |
| password  | Min length of 8 characters. Must contain at least one uppercase, one lowercase, one number and a symbol |

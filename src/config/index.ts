...
export const CRYPTO_ALGORITHM = process.env.CRYPTO_ALGORITHM ? process.env.CRYPTO_ALGORITHM : "";
export const CRYPTO_SECRET_KEY = process.env.CRYPTO_SECRET_KEY ? process.env.CRYPTO_ALGORITHM : "";